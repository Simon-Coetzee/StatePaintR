...
```{r, message = FALSE}
vista.enhancers <- read_tsv("statepaintr_data/VISTA_invivo_tested.bed", col_names = FALSE)
vista.enhancers
```
...
```{r, message = FALSE}
vista.human <- read_tsv("statepaintr_data/VISTA_invivo_tested_hg19.bed", col_names = FALSE)
...
```{r}
download.file("http://dx.doi.org/10.1371/journal.pcbi.1003677.s018", destfile = "statepaintr_data/enhancerfinder.predictions.zip")
unzip("statepaintr_data/enhancerfinder.predictions.zip", exdir = file.path("statepaintr_data", "enhancer_predictions", "enhancerfinder"))
l.ef.enhancer <- read.delim(file.path("statepaintr_data", "enhancer_predictions", "enhancerfinder", "enhancerfinder_limb_hg19.bed"))
h.ef.enhancer <- read.delim(file.path("statepaintr_data", "enhancer_predictions", "enhancerfinder", "enhancerfinder_heart_hg19.bed"))
b.ef.enhancer <- read.delim(file.path("statepaintr_data", "enhancer_predictions", "enhancerfinder", "enhancerfinder_brain_hg19.bed"))
...
pd.enrichment <- read.delim("statepaintr_data/PD.enrichment.27461410.txt", sep = "\t", header = TRUE)
head(pd.enrichment)
...
```{r}
sessionInfo()
file.remove("statepaintr_data", recursive = TRUE)
```
