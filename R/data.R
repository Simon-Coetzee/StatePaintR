...
#' Default Segmentation Colors
#'
#' A table describing the default colors for the default
#' state definitions
#'
#' load with \code{data(Cedars.BFG.states)}
#'
#' @return \code{matrix} of states
#' @format A data.frame with 20 states and colors:
#' \describe{
#'   \item{TRS}{Transcribed Regions}
#'   \item{HET}{Heterochromatin Regions}
#'   \item{SCR}{Silenced Regions}
...
#'   \item{ARC}{Active Region, Core}
#'   }
#' @details Colors are intended to be simmilar to chromHMM to facilitate comparison.
#'
#' @source \url{"http://github.com/Simon-Coetzee/StateHub/"}
#' @examples
#' data(Cedars.BFG.colors)
#' Cedars.BFG.colors
